...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Misbah</a>
...
<div class="container-fluid">
   ...
   <div class="col-lg-6 col-md-6 col-12">
    <img src="images/cc3.jpg" class="image-fluid aboutimg">
      ...
      <div class="col-lg-6 col-md-6 col-12">
       <h2 class="display -4">yaha bh thek krna😢.</h2>
          </div>
      </div>
             </div>
             <p class="py-3">
paragraph ae ga yaha✌
...
<a href="about.php" class="btn btn success"> check more </a>
     ...
     <div class="container-fluid">
       <div class="row">
          ...
          <section class="my-5">
           ...
           <div class="col-lg-4 col-md-4 col-12">
            <img src="images/ccl.jpg" class="img-fluid pb-3s"
          <div>
            <div class="col-lg-4 col-md-4 col-12">
              <img src="images/ccl.jpg" class="img-fluid pb-3s"
            </div>
    ...
    <script src="https://maxcdn.bootstrap.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    </body>
    </html>
